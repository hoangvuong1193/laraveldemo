                ...
                <div class="panel panel-default">
                    ...
                    @endif
				    	...
				    	<form action="nguoidung" method="POST">
				    		...
				    		<div>
				    			<label>Họ tên</label>
							  	<input type="text" class="form-control" value="{{Auth::user()->name}}" placeholder="Username" name="ten" aria-describedby="basic-addon1">
							</div>
							<br>
							<div>
				    			<label>Email</label>
							...
							<br>	
							<div>
								<input type="checkbox" class="" name="changpass" id="changepass">
